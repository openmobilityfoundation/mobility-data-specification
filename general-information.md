...
| `on_trip` | `on_trip `   | `trip_enter_geography` | **[Beta feature](/general-information.md#beta-features):** *Yes (as of 1.1.0)*. The vehicle enters one or more Geographies managed by Policy during an active trip. |
| `on_trip` | `on_trip `   | `trip_leave_geography` | **[Beta feature](/general-information.md#beta-features):** *Yes (as of 1.1.0)*. The vehicle leaves one or more Geographies managed by Policy during an active trip. |
