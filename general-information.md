...
| `on_trip` | `on_trip `   | `crossed_geography_boundary` | **[Beta feature](/general-information.md#beta-features):** *Yes (as of 1.1.0)*. The vehicle has entered or left one or more Geographies managed by a Policy. See [Geometry Driven Events](#geometry-driven-events).|
