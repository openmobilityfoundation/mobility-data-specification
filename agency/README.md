...
| scheduled_trip_start_time | Timestamp     | Conditionally Required | Time the trip was scheduled to start. Only applicable in the case where `reservation_type` is `scheduled`                                                                                                                                                                                                                     |
