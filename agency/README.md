...
| `event_type`         | `event_reason`                                          | description                                                                                    | valid initial `status`                             | `status` on success | status_description                                                      |
| -------------------- | ------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | -------------------------------------------------- | ------------------- | ----------------------------------------------------------------------- |
...
| `trip_enter`         |                                                         | Customer enters a service area managed by agency during an active trip.                        | `removed`, `elsewhere`                             | `trip`              |                                                                         |
...
| `service_end`        | `low_battery`, `maintenance`, `compliance`, `off_hours` | A vehicle is no longer available due to `event_reason`                                         | `available`                                        | `unavailable`       |                                                                         |
