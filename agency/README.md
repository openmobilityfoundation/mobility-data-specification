...
List of valid vehicle events and the resulting vehicle status.

| `event_type`           | description                                                                                          | resulting `status`  | status_description                                                      |
| ---------------------- | ---------------------------------------------------------------------------------------------------- | ------------------- | ----------------------------------------------------------------------- |
| `service_start`        | Vehicle introduced into service at the beginning of the day (if program does not operate 24/7)       | `available`         | Vehicle is on the street and available for customer use.                |
| `trip_end`             | Customer ends trip and reservation                                                                   | `available`         |                                                                         |
| `rebalance_drop_off`   | Vehicle moved for rebalancing                                                                        | `available`         |                                                                         |
| `maintenance_drop_off` | Vehicle introduced into service after being removed for maintenance                                  | `available`         |                                                                         |
| `cancel_reservation`   | Customer cancels reservation                                                                         | `available`         |                                                                         |
| `reserve`              | Customer reserves vehicle                                                                            | `reserved`          | Vehicle is reserved or in use.                                          |
| `trip_start`           | Customer starts a trip                                                                               | `trip`              |                                                                         |
| `trip_enter`           | Customer enters a service area managed by agency during an active trip.                              | `trip`              |                                                                         |
| `trip_leave`           | Customer leaves a service area managed by agency during an active trip.                              | `elsewhere`         |                                                                         |
...
| `low_battery`          | A vehicle is no longer available due to insufficient battery                                         | `unavailable`       |                                                                         |
| `maintenance`          | A vehicle is no longer available due to equipment issues                                             | `unavailable`       |                                                                         |
| `service_end`          | Vehicle removed from street because service has ended for the day (if program does not operate 24/7) | `removed`           | A vehicle is removed from the street and unavailable for customer use.  |
| `rebalance_pick_up`    | Vehicle removed from street and will be placed at another location to rebalance service              | `removed`           |                                                                         |
| `maintenance_pick_up`  | Vehicle removed from street so it can be worked on                                                   | `removed`           |                                                                         |
| `deregister`           | A vehicle is deregistered                                                                            | `inactive`          | A vehicle is deactivated from the fleet and unavailable.                |
