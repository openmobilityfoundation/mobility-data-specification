...
| `provider_pick_up`   | `rebalance`, `maintenance`, `charge`, `compliance`      | Vehicle removed from street and will be placed at another location to rebalance service        | `available`, `unavailable`, `elsewhere`, `missing` | `removed`           |                                                                         |
| `city_pick_up`       |                                                         | Vehicle removed by city                                                                        | `available`, `unavailable`, `missing`              | `removed`           |                                                                         |
...
| `trip_start`         |                                                         | Customer starts a trip                                                                         | `available`, `reserved`, `missing`                 | `trip`              |                                                                         |
...
| `lost`               |                                                         | Vehicle is missing but not yet deregistered                                                    | `available`, `unavailable`, `removed`, `elsewhere` | `missing`           | A vehicle is missing but not yet deactivated from the fleet.            |
| `deregister`         | `decommissioned`                                        | A vehicle is deregistered                                                                      | `available`, `unavailable`, `removed`, `elsewhere` | `inactive`          | A vehicle is deactivated from the fleet.                                |
