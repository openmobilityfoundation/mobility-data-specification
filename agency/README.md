...
| `service_start`      |                                                         | Vehicle gets back into service and is available again                                          | `unavailable`                                      | `available`         | Vehicle is on the street and available for customer use.                |
...
| `provider_drop_off_unavailable` |                                              | Vehicle is put back in the street, but is unavailable until further notice                     | `removed`, `elsewhere`                             | `unavailable`       |                                                                         |
...
| `trip_end_unavailable` |                                                       | Customer ends trip and reservation, vehicle is unavailable until further notice                | `trip`                                             | `unavailable`       |                                                                         |
